...
namespace CSGOInjector
{
    public static class VACBypass
    {
        ...
        private static IntPtr hGameVac = IntPtr.Zero;
        private static UInt32 pid = UInt32.MinValue;
        private static UInt32 pidVac = UInt32.MinValue;

        public static bool Run(string pathVac)
        {
            Init();
            ...
            MessageBox.Show("Vac Bypass Injected", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);

            return true;
        }

        public static void InjectSteam(string pathVac)
        {
            IntPtr handle = OpenProcess(ProcessAccessFlags.All, false, (Int32)pidVac);
            ...
            IntPtr size = (IntPtr)pathVac.Length;
            ...
            byte[] bytes = Encoding.ASCII.GetBytes(pathVac);
        ...
        public static bool RunCSGO(string pathToDLL)
        {
            Init();
        ...
        private static void Init()
        {
            ...
            hGame = IntPtr.Zero;
            hGameVac = IntPtr.Zero;
            pidVac = UInt32.MinValue;
            pid = UInt32.MinValue;
        }
        ...
        {
            IntPtr hwGame = (IntPtr)FindWindow(null, "Counter-Strike: Global Offensive - Direct3D 9");
        ...
        private static UInt32 GetSteamPID()
        {
            ...
            //Thread.Sleep(10000);
            IntPtr hwGame = (IntPtr)FindWindow(null, "Steam");
